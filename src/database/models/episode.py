...
class EpisodeModel(Base):
	...
	shots = relationship('database.models.shot.ShotModel', back_populates='episode', foreign_keys='database.models.shot.ShotModel.scene_id', cascade='all, delete-orphan')
